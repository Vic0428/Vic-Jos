...
// The entry.S page directory maps the first 5MB of physical memory
// starting at virtual address KERNBASE (that is, it maps virtual
// addresses [KERNBASE, KERNBASE+5MB) to physical addresses [0, 5MB)).
// We choose 5MB because that's how much we can map with two page
// table and it's enough to get us through early boot.  We also map
// virtual addresses [0, 5MB) to physical addresses [0, 5MB); this
